...
def parse_arguments():
    ...
    parser.add_argument(
        "--content_dir",
        type=str,
        default="/home/ubuntu/Desktop/NST_Code/content_data",
        help="Location of content dataset",
    )
    parser.add_argument(
        "--style_dir",
        type=str,
        default="/home/ubuntu/Desktop/NST_Code/style_data",
        help="Location of style dataset",
    )
    parser.add_argument(
        "--vgg",
        type=str,
        default="/home/ubuntu/Desktop/NST_Code/vgg_normalised.pth",
        help="Location of pre-trained VGG",
    )
    parser.add_argument(
        "--experiment", type=str, default="experiment1", help="Name of experiment"
    )

    parser.add_argument(
        "--final_size", type=int, default=256, help="Size of final image"
    )
    parser.add_argument(
        "--content_size", type=int, default=512, help="Size of content image"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--lr_decay", type=float, default=5e-5, help="Learning rate decay"
    )

    parser.add_argument("--epochs", type=int, default=1, help="Number of epochs")

    parser.add_argument(
        "--content_weight", type=float, default=1.0, help="Content weight"
    )
    ...
    parser.add_argument(
        "--decoder_path", type=str, default=None, help="Path to decoder checkpoint"
    )

    parser.add_argument(
        "--optimizer_path", type=str, default=None, help="Path to optimizer checkpoint"
    )
